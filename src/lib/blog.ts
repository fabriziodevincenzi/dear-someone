...
export const blogArticles: BlogArticle[] = [
  {
    ...
    paragraphs: [
      ...
      'Dear Someone begins with a smaller possibility: one person writes to one person they do not know, and the message asks for nothing beyond a little attention. There is no profile to maintain and no public reaction to collect.',
